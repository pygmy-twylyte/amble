...
use crate::{
    ...
    item::{ConsumableOpts, ConsumeType, ContainerState, Item, ItemAbility, ItemInteractionType, Movability},
    world::AmbleWorld,
};
...
impl RawItemAbility {
    ...
    pub fn to_ability(&self, symbols: &SymbolTable) -> Result<ItemAbility> {
        let ability = match self {
            ...
            Self::Drink => ItemAbility::Drink,
            Self::Eat => ItemAbility::Eat,
            Self::Extinguish => ItemAbility::Extinguish,
            Self::Ignite => ItemAbility::Ignite,
            Self::Inhale => ItemAbility::Inhale,
